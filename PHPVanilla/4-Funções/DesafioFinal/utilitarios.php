...
// ==========================================
// Converter nome completo para iniciais UpperCase
function gerarIniciais(string $nomeCompleto): string {
    ...
    foreach ($palavras as $palavra) {
        if ($palavra !== "") {
            $iniciais .= substr($palavra, 0, 1); // pegar a primeira letra da palavra na variável $iniciais
        }
    }
    // devolver as iniciais
    return strtoupper($iniciais); // devolver as iniciais todas maiusculas
}
