...
Usando a extensão do VSCode = postgresql -> instalar a extensão do Chris Kolkman
...
Adicionamos as informações relativas a infraestrutura do banco de dados e e adicionamos o caminho do arquivo ao .gitignore (o arquivo não é versionado e não tem perigo de vazar informações confidenciais para a internet)
...
Gerenciar o fluxo de inicialização, teste de latência de banco, leitura das informações do banco e tratar falhas e auditar em um arquivo log